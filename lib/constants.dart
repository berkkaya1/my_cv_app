...
const TextStyle kCardElementTextStyle = TextStyle(
  fontSize: 25,
  fontFamily: "Bebas",
  color: Colors.blueGrey,
);
const TextStyle kRegularSmallTextStyle =
    TextStyle(fontFamily: "Bebas", fontSize: 18);
const TextStyle kBoldTextStyle =
    TextStyle(fontFamily: "Bebas", fontWeight: FontWeight.bold, fontSize: 18);
